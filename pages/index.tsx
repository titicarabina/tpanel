...
import namu from "../public/namu.png";
import yara from "../public/yara.png";
import casa from "../public/casa.png";
import evalobiz from "../public/evalobiz.png";
import depoviseu from "../public/depoviseu.png";
import pro from "../public/pro.png";
const Home: NextPage = () => {
  function handleClickScroll(elem: string) {
  ...
  return (
    <>
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                  ...
                  >
                    <a
                      className="hover:text-blue-700  cursor-pointer block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-blue-700 lg:dark:hover:bg-transparent dark:border-gray-700"
                      aria-current="page"
                    >
                      Incearca gratuit
                    </a>
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
              Registru online intrari, iesiri.
            </h1>
            ...
            <a
              ...
              className="cursor-pointer inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 mb-2 mt-2"
            >
              Incearca gratuit
              <svg
      ...
      <section className="bg-white dark:bg-gray-900" id="start">
          ...
          <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
            ...
            >
              <Image
                ...
                alt="namu"
                height={100}
                className="h-9 hover:text-gray-900 dark:hover:text-white brightness-50 hover:brightness-100 transition-all duration-100"
              />
            </a>
            <a
              href="https://hotelyara.ro"
              className="flex justify-center items-center"
            >
              <Image
                src={yara}
      ...
      <section className="bg-white dark:bg-gray-900" id="preturi">
